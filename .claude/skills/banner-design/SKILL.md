...
2. **Generate visual elements** with AI models as available

### Step 4: Export Banners to Images

After designing HTML banners, export each to PNG using screenshots at exact platform dimensions.
...
Present all exported images side-by-side showing art direction style, key design rationale, and file path & dimensions.
